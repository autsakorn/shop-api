...
func (m *Brand_20200527_115926) Up() {
	...
	m.SQL("CREATE TABLE brand(id serial primary key,title char(255) NOT NULL,slug TEXT NOT NULL,created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,updated_at TIMESTAMP WITHOUT TIME ZONE NOT NULL)")
}
